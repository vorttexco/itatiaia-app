...
class AudioPlayerHandlerImpl extends BaseAudioHandler
  ...
  // static final AudioPlayerHandlerImpl _singleton =
  ...
  var _mediaLibrary = MediaLibrary();
  @override
  ...
  setMediaLibrary(MediaLibrary library) => _mediaLibrary = library;
  ...
  AudioPlayerHandlerImpl(MediaLibrary library) {
  ...
  Future<void> prepareToPlay(MediaItem item) async {
    ...
    _playlist.addAll([AudioSource.uri(Uri.parse(item.id))]);
...
class MediaLibrary {
  static const albumsRootId = 'radios';

  var items = <String, List<MediaItem>>{
